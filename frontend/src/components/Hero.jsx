...
import heroIllustration from '../assets/hero-illustration.png'; // Assuming this image path
      ...
      <div className="py-20 bg-base-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-xl text-base-content/90 mb-12 max-w-4xl mx-auto leading-relaxed">
            CommitMate is a platform designed to foster meaningful collaboration
            among developers. Our mission is to transform how coding projects
            are created by connecting talented developers and facilitating
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Integrated Git support for smooth collaboration.',
                icon: '🔄',
                color: 'warning',
              },
            ].map((feature, index) => (
